...
class ViewController: UIViewController, UICollisionBehaviorDelegate {
    ...
    let data = ["O mnie", "Moje doświadczenie", "Moje pasje i zainteresowania"]
    let dataForTextView = ["Nazywam się Sebastian Pszczółkowski. Jestem Studentem Polsko-Japońskiej Akademii Technik Komputerowych w Warszawie. Moja przygoda z programowaniem zaczęła się w technikum. Od tamtego czasu prężnie rozwijam swoje umiejętności ucząc się różnych jezyków programowania. Swift stał się tym, z któtym chciałbym związać się na dłużej. Stąd też moja aplikacja do Summer e-Xperience o którym słyszałem wiele dobrego.", "Jakby to powiedzieć, jest to poczatek mojej drogi w programowaniu na urzadzenia z systemem iOS. W przeszłości miałem okazje programować w jezykach takich jak Java, C++, C, C#, jednak żaden nie skradł mojego serca tak jak Swift. Uczę sie go od kilku miesięcy, na początku oglądajac tutoriale i starając się je zrozumieć. Po zakupie sprzętu przyszedł czas na praktykę i sumienne pogłębianie swoich umiejętności.", "Interesuję się wszystkim co mnie zaciekawi, potrafię godzinami zagłębiać się w dany temat, czego skutkiem jest niezliczona ilość uruchomionych kart w przeglądarce. Czasem wątki tworzą nowe wątki. Gdy kończe czytać dany artykuł zastanawiam się co ja własciwie tu robię i skąd przyszedłem. Jeśli chodzi o moje hobby to jest nim zbieranie gadżetów elektronicznych, mimo ze mam juz dużo to wciaż pojawia się w moim polu widzenia coś co również chciałbym mieć i przetestować. Gdy znajomi potrzebują coś z tego typu gadżetów, zawsze się mnie radzą. Kolejna moją zajawką jest podróżowanie, uwielbiam poznawać nowych ludzi i miejsca. Każdy myśli, podrożowanie? Kto tego nie lubi. To prawda, ale moim środkiem transportu jest AutoStop, co czyni to podrożowanie o wiele bardziej satysfakcjonującym i przyjemnym. Mogłbym na ten temat mówić godzinami, opowiadać co mi sie po drodze przytrafiło, albo jakich ludzi poznałem. Kto wie może porozmawiamy o tym na rozmowie kwalifikacyjnej ;)"]
